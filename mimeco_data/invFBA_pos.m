...
function [objL1, flagL1, objL0, flagL0, objBase, flagBase, sum_eps] = invFBA_pos(v, lb, ub, S, l0, useL2, c_fix, c_fix_idx, min_obj, lower_bound_obj)
    arguments
        v
        lb
        ub
    ...
    if useL2 == true
       prob2.Objective = sum((c_pos).^2);
    else
       prob2.Objective = sum(c_pos); 
    end
    ...
    if l0 
        ...
        prob3.Constraints.z_link = c_pos <= z;
